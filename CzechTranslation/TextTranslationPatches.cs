...
namespace CzechTranslation
{
    ...
    public static class TextTranslationPatches
    {
        ...
        public static bool TextTranslation_SetLanguage(TextTranslation.Language lang, TextTranslation __instance)
        {
            ...
            var path = CzechTranslation.Instance.ModHelper.Manifest.ModFolderPath + "/" + CzechTranslation.translationFile;
            CzechTranslation.WriteLine($"Loading translation from {path}");
            ...
            {
                CzechTranslation.WriteError($"Couldn't load translation: {e.Message}{e.StackTrace}");
                return true;
            }
